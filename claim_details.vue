<template>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
     ...
     <i class="fa fa-user" id="user" aria-hidden="true" style="font-size:20px;color:black;text-align: center;">&nbsp;<button class="btn">Brundha</button> </i>
...
<tr>
      ...
      <tr  >
        <!-- <td> {{ users.data.data[3].employee }} </td>  -->
...
<table v-if="retrieveFlag" class="table table-striped table-dark">
  <tr>
      <td> <b>claim id</b> </td>
    ...
    <table v-if="retrieveFlag1" class="table table-striped table-dark">
      <tr>
      <td> <b>claim id</b> </td>
      <td> <b>claim category</b> </td>
      <td> <b>Description</b></td>
...
<div id="popup1" class="overlay" >
  ...
  <select name="claim category" id="category" v-model="claimCategory" placeholder="select"   @click="getcatdata()">
    <option value="travel"> Travel{{ category[0] }}</option>
    <option value="Office stationery"> Office stationery{{ category[1] }}</option>
    <option value="others"> Others{{ category[2] }}</option>
    &nbsp;
 </select>
 <br/>
 <br/>
